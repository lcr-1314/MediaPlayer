...
public:
    WlCallJava(JavaVM *javaVM, JNIEnv *env, jobject *jobj);
    ~WlCallJava();
    ...
    void onCallInitMediacodec(const char *mine, int width, int height, int csd0_size, int csd1_size, uint8_t*csd_0, uint8_t *scd_1);
