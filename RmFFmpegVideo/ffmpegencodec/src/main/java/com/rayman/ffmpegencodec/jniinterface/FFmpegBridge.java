package com.rayman.ffmpegencodec.jniinterface;
...
//    public static native String getFFmpegConfig();
    public static String getFFmpegConfig(){
        return "";
    }
...
//    private static native int jxCMDRun(String cmd[]);
    private static int jxCMDRun(String cmd[]){
        return 0;
    }
...
//    public static native int encodeFrame2H264(byte[] data);
    public static int encodeFrame2H264(byte[] data){
        return 0;
    }
...
//    public static native int encodeFrame2AAC(byte[] data);
    public static int encodeFrame2AAC(byte[] data){
        return 0;
    }
...
//    public static native int prepareJXFFmpegEncoder(String mediaBasePath, String mediaName, int filter,int in_width, int in_height, int out_width, int  out_height, int frameRate, long bit_rate);
    public static int prepareJXFFmpegEncoder(String mediaBasePath, String mediaName, int filter,int in_width, int in_height, int out_width, int  out_height, int frameRate, long bit_rate){
        return 0;
    }
...
//    public static void initJXFFmpeg(boolean debug,String logUrl){
//
//    }
