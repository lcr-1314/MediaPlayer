package com.rayman.rmffmpegvideo;
...
import com.rayman.rmffmpegvideo.model.AutoVBRModel;

import com.rayman.ffmpegencodec.FFmpegEncodec;
import com.rayman.rmffmpegvideo.model.CBRModel;
import com.rayman.rmffmpegvideo.model.LocalMediaConfig;
import com.rayman.rmffmpegvideo.model.OnlyCompressOverBeanl;
import com.rayman.rmffmpegvideo.model.VBRModel;
import com.rayman.rmffmpegvideo.nativeutils.DeviceUtils;
import com.rayman.rmffmpegvideo.nativeutils.JianXiCamera;
import com.rayman.rmffmpegvideo.nativeutils.LocalMediaCompress;
import com.rayman.rmffmpegvideo.nativeutils.MediaRecorderActivity;
import com.rayman.rmffmpegvideo.model.BaseMediaBitrateConfig;
import com.rayman.rmffmpegvideo.model.MediaRecorderConfig;
import com.rayman.rmffmpegvideo.nativeutils.StringUtils;
    ...
    public void initVideo() {
        ...
        if (DeviceUtils.isZte()) {
            if (dcim.exists()) {
                ...
                JianXiCamera.setVideoCachePath(dcim.getPath().replace(
                        "/sdcard/", "/sdcard-ext/") + "/mabeijianxi/");
            }
        } else {
            JianXiCamera.setVideoCachePath(dcim + "/mabeijianxi/");
        }
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    if (!TextUtils.isEmpty(mime_type) && mime_type.contains("video") && !TextUtils.isEmpty(_data)) {
                        ...
                        if (compressModeCheckedId == R.id.rb_cbr) {
                            ...
                            compressMode = new CBRModel(166, Integer.valueOf(bitrate));
                            ...
                            if (TextUtils.isEmpty(crfSize)) {
                                compressMode = new AutoVBRModel();
                            } else {
                                compressMode = new AutoVBRModel(Integer.valueOf(crfSize));
                            }
                            ...
                            compressMode = new VBRModel(Integer.valueOf(maxBitrate), Integer.valueOf(bitrate));
                        } else {
                            compressMode = new AutoVBRModel();
                        }
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                OnlyCompressOverBeanl onlyCompressOverBean = new LocalMediaCompress(config).startCompress();
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        hideProgress();
