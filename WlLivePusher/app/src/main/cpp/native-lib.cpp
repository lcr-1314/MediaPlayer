...
Java_com_android_wllivepusher_MainActivity_stopRecord(JNIEnv *env, jobject thiz) {
    finish = true;
}

extern "C"
JNIEXPORT void JNICALL
Java_com_android_wllivepusher_MainActivity_startRecord(JNIEnv *env, jobject thiz, jstring _path) {
    if(finish)
    {
        return;
    }
