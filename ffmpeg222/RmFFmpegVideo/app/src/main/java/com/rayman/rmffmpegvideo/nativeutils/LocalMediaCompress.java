package com.rayman.rmffmpegvideo.nativeutils;
...
import com.rayman.rmffmpegvideo.model.MediaObject;
...
public class LocalMediaCompress extends MediaRecorderBase {
    ...
    private final OnlyCompressOverBeanl mOnlyCompressOverBean;
    ...
    public LocalMediaCompress(LocalMediaConfig localMediaConfig) {
        ...
        mOnlyCompressOverBean = new OnlyCompressOverBeanl();
    ...
    public OnlyCompressOverBeanl startCompress() {
