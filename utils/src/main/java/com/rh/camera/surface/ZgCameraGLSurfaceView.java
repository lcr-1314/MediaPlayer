...
public class ZgCameraGLSurfaceView extends ExtGLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private BlockingQueue<ZgCameraFrameData> mImageRenderBuffers;
    private GLES2Render mGLES2Render;
    private OnRenderListener mOnRenderListener;
    private OnDrawListener mOnDrawListener;

    public interface OnDrawListener{
        void onDrawOverlap(GLES2Render render);
    }

    public interface OnRenderListener {
        void onBeforeRender(ZgCameraFrameData data);
        void onAfterRender(ZgCameraFrameData data);
    }

    public ZgCameraGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        onCreate();
    }

    public ZgCameraGLSurfaceView(Context context) {
        super(context);
        onCreate();
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ZgCameraFrameData data = mImageRenderBuffers.poll();
        if (data != null) {
    ...
    public void requestRender(ZgCameraFrameData data) {
